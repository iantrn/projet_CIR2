...
CREATE TABLE amenageur_operateur (
  ...
  contact_amenageur_operateur VARCHAR(255) NOT NULL,
  telephone_operateur VARCHAR(255),
  CONSTRAINT amenageur_operateur_PK PRIMARY KEY (id_acteur)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE station (
  ...
  CONSTRAINT station_id_amenageur_FK FOREIGN KEY (id_amenageur) REFERENCES amenageur_operateur (id_acteur),
  CONSTRAINT station_id_operateur_FK FOREIGN KEY (id_operateur) REFERENCES amenageur_operateur (id_acteur),
...
CREATE TABLE point_de_recharge (
  ...
  puissance_nominale DECIMAL(6,2) NOT NULL,
